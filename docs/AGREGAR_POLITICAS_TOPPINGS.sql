-- 🍔 Agregar políticas de storage para toppings
-- Este SQL agrega soporte para la carpeta toppings/ sin modificar las políticas existentes
-- Ejecutar en Supabase SQL Editor

-- ⚠️ IMPORTANTE: Este SQL NO elimina políticas existentes
-- Solo agrega políticas adicionales para la carpeta toppings/
