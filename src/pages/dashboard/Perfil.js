                  ...
                  {!activeConfigSection && (
                    <div className="perfil-config-grid">
                        ...
                        <FeatureGuard
                          ...
                          fallback={
                            <motion.div
                              ...
                              onClick={() => toast.error('La gestión de equipo está disponible en un plan superior. Actualiza tu plan para añadir más miembros.')}
                              style={{ opacity: 0.6 }}
                            >
                              <div className="config-icon-wrapper" style={{ filter: 'grayscale(100%)' }}>
                                <Shield size={24} />
                              </div>
                              <h3>Equipo 🔒</h3>
                      ...
                      >
                        ...
                        <p>Configurar datos de facturación y mensajes de facturas</p>
                      </motion.div>
                      ...
                      >
                        ...
                        <p>Configuraciones generales y tipo de negocio</p>
                      </motion.div>
